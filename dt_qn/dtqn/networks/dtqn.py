...
from pytorch_conversion.posencoder import PositionalEncoding
from gates import GRUGate, ResGate
from pytorch_conversion.transformer_remade import TransformerModel
